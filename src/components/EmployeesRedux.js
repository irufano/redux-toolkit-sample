...
let EmployeesRedux = () => {
  ...
  let changeUpdateSelected = (employeeId) => {
    dispatch(updateSelected(employeeId));
  };
        ...
        <div className="row">
          <div className="col">
            ...
            <p>
              ...
              cumque fuga dicta velit deserunt magni corrupti fugiat enim
              repellat reprehenderit assumenda non vero nostrum veniam corporis
              rerum nesciunt aliquam dolore.
            </p>
          </div>
        </div>
        <div className="row">
